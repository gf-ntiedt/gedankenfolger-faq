...
- **testing:** Remove Playwright E2E test setup and related CLI commands (9663a7b)
...
- **accordion:** Correct arrow indicator and open-state markup for both layouts (a6f48b8)
...
- **testing:** Add CLI commands and Playwright tests for content element variants (4fb75b7)
...
- **deps:** Require brotkrueml/schema and wapplersystems/ws-scss (c920ec3)
